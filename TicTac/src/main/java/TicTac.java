 ...
 * Author: Leo Yang
 * Date: April 20, 2023
 * Description: Duck themed version of the game of TicTacToe
 * Allows for users to restart game and keep score
 */
...
public class TicTac extends JFrame { //sets up our TicTac class gets access to everything in the JFrame class 
    ...
    public TicTac() {  //creates the method to draw the game board
        ...
        setBackground(Color.GREEN);//sets background to green
